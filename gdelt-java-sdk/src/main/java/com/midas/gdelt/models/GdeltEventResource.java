package com.midas.gdelt.models;
...
public class GdeltEventResource implements Serializable
{
    ...
    public void persist(Persistence persistence){
        ...
        data.put("actor1CountryCode", actor1CountryCode);
        data.put("actor1KnownGroupCode", actor1KnownGroupCode);
        data.put("actor1EthnicCode", actor1EthnicCode);
        data.put("actor1Religion1Code", actor1Religion1Code);
        data.put("actor1Religion2Code", actor1Religion2Code);
        data.put("actor1Type1Code", actor1Type1Code);
        data.put("actor1Type2Code", actor1Type2Code);
        data.put("actor1Type3Code", actor1Type3Code);
        data.put("actor2Code", actor2Code);
        data.put("actor2Name", actor2Name);
        data.put("actor2CountryCode", actor2CountryCode);
        data.put("actor2KnownGroupCode", actor2KnownGroupCode);
        data.put("actor2EthnicCode", actor2EthnicCode);
        data.put("actor2Religion1Code", actor2Religion1Code);
        data.put("actor2Religion2Code", actor2Religion2Code);
        data.put("actor2Type1Code", actor2Type1Code);
        data.put("actor2Type2Code", actor2Type2Code);
        data.put("actor2Type3Code", actor2Type3Code);
        data.put("isRootEvent", isRootEvent);
        data.put("eventCode", eventCode);
        data.put("eventBaseCode", eventBaseCode);
        data.put("eventRootCode", eventRootCode);
        data.put("quadClass", quadClass);
        data.put("goldsteinScale", goldsteinScale);
        data.put("numMentions", numMentions);
        data.put("numSources", numSources);
        data.put("numArticles", numArticles);
        data.put("avgTone", avgTone);
        data.put("actor1GeoType", actor1GeoType);
        data.put("actor1GeoFullName", actor1GeoFullName);
        data.put("actor1GeoCountryCode", actor1GeoCountryCode);
        data.put("actor1GeoADM1Code", actor1GeoADM1Code);
        data.put("actor1GeoADM2Code", actor1GeoADM2Code);
        data.put("actor1GeoLat", actor1GeoLat);
        data.put("actor1GeoLong", actor1GeoLong);
        data.put("actor1GeoFeatureID", actor1GeoFeatureID);
        data.put("actor2GeoType", actor2GeoType);
        data.put("actor2GeoFullName", actor2GeoFullName);
        data.put("actor2GeoCountryCode", actor2GeoCountryCode);
        data.put("actor2GeoADM1Code", actor2GeoADM1Code);
        data.put("actor2GeoADM2Code", actor2GeoADM2Code);
        data.put("actor2GeoLat", actor2GeoLat);
        data.put("actor2GeoLong", actor2GeoLong);
        data.put("actor2GeoFeatureID", actor2GeoFeatureID);
        data.put("actionGeoType", actionGeoType);
        data.put("actionGeoFullName", actionGeoFullName);
        data.put("actionGeoCountryCode", actionGeoCountryCode);
        data.put("actionGeoADM1Code", actionGeoADM1Code);
        data.put("actionGeoADM2Code", actionGeoADM2Code);
        data.put("actionGeoLat", actionGeoLat);
        data.put("actionGeoLong", actionGeoLong);
        data.put("actionGeoFeatureID", actionGeoFeatureID);
